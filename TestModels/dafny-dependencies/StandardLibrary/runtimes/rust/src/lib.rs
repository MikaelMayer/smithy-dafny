...
mod TestUTF8 {
    ...
    fn TestDecodeHappyCase() {
        let unicodeBytes =
            ::dafny_runtime::seq![0x61, 0x62, 0x63, 0xCC, 0x86, 0xC7, 0xBD, 0xCE, 0xB2];
        assert!(implementation_from_dafny::UTF8::_default::Uses2Bytes(
        ...
        assert!(implementation_from_dafny::UTF8::_default::ValidUTF8Range(
            &unicodeBytes,
            &::dafny_runtime::int!(7),
            &::dafny_runtime::int!(9)
        ));
    ...
    fn Test1Byte() {
        ...
        assert!(implementation_from_dafny::UTF8::_default::Uses1Byte(
            &encoded
        ));
    ...
    fn Test3Bytes() {
        ...
        assert!(implementation_from_dafny::UTF8::_default::Uses3Bytes(
            &encoded
        ));
        let mut _r2 = implementation_from_dafny::UTF8::_default::Decode(&encoded);
        assert!(!_r2.IsFailure());
    ...
    fn Test4Bytes() {
        ...
        assert!(implementation_from_dafny::UTF8::_default::Uses4Bytes(
            &encoded
        ));
        let mut _r2 = implementation_from_dafny::UTF8::_default::Decode(&encoded);
        assert!(!_r2.IsFailure());
